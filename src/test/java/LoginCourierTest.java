...
public class LoginCourierTest {
    ...
    @Test
    @DisplayName("Вход под несуществующим логином")
    ...
    @Test
    @DisplayName("Вход под несуществующим паролем")
    ...
    @Test
    @DisplayName("Успешный вход курьера с обязательными полями")
    ...
    @Test
    @DisplayName("Вход курьера без логина невозможен")
    ...
    @Test
    @DisplayName("Вход курьера без пароля невозможен")
